...
program invnormPY
  gen `1'_smkPY=.
  regress `1' `2' packyear2010 if `3'==2 & fev+fvc+packyear2010!=.
  local N1=e(N)+1
  predict tt, resid
  pctile p`1'=tt, nq(`N1') genp(p_`1')
...
invnormPY fev "sex age agesq height PC1-PC4" smk
invnormPY fvc "sex age agesq height PC1-PC4" smk
invnormPY pef "sex age agesq height PC1-PC4" smk
invnormPY ff "sex age agesq height PC1-PC4" smk
rename id IID
save tmp, replace
use dta
keep FID id
